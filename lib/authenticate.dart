...
enum MobileAuthenticationState { SHOW_MOBILE_FORM_STATE, SHOW_OTP_FORM_STATE }
...
class _AuthenticateState extends State<Authenticate> {
  MobileAuthenticationState currentState =
      MobileAuthenticationState.SHOW_MOBILE_FORM_STATE;
            ...
            await _auth.verifyPhoneNumber(
                ...
                codeSent: (verificationId, resendingToken) async {
                  setState(() {
                    this.showLoading = false;
                    currentState =
                        MobileAuthenticationState.SHOW_OTP_FORM_STATE;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        body: showLoading
            ...
            : currentState == MobileAuthenticationState.SHOW_MOBILE_FORM_STATE
                ? getFormWidget(context)
                : getOTPWidget(context));
  }
}
