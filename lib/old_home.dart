...
class NotHome extends StatefulWidget {
  ...
  NotHome(@required this.user);

  @override
  State<StatefulWidget> createState() {
    return _NotHomeState(user);
  }
}
...
class _NotHomeState extends State<NotHome> {
  ...
  _NotHomeState(@required this._user);

  @override
  void initState() {
    getChats();
    timer =
        Timer.periodic(Duration(seconds: 5), (Timer t) => checkForNewWaves());
    super.initState();
  }
                  ...
                  return InkWell(
                    onTap: () {
                      Navigator.push(
                          ...
                          MaterialPageRoute(
                              builder: (context) =>
                                  ChatPage(_user.uid, user_uid, user_name)));
                    },
                    child: Container(
